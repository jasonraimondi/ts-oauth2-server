...
By default, the implicit grant appends tokens to the redirect URI using query parameters for backwards compatibility. [RFC 6749 §4.2.2](https://datatracker.ietf.org/doc/html/rfc6749#section-4.2.2) recommends using URI fragments instead. To enable fragment mode:
