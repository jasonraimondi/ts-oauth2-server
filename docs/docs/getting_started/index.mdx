...
<Tabs>
  <TabItem value="pnpm" label="pnpm">
    <CodeBlock lang="bash">pnpm add @jmondi/oauth2-server</CodeBlock>
  </TabItem>
  <TabItem value="npm" label="npm">
    <CodeBlock lang="bash">npm install --save @jmondi/oauth2-server</CodeBlock>
  </TabItem>
  <TabItem value="yarn" label="yarn">
    <CodeBlock lang="bash">yarn add @jmondi/oauth2-server</CodeBlock>
  </TabItem>
  <TabItem value="jsr" label="jsr">
    <CodeBlock lang="bash">npx jsr add @jmondi/oauth2-server</CodeBlock>
  </TabItem>
  <TabItem value="deno" label="deno">
    <CodeBlock lang="bash">deno add @jmondi/oauth2-server</CodeBlock>
  </TabItem>
  <TabItem value="bun" label="bun">
    <CodeBlock lang="bash">bunx jsr add @jmondi/oauth2-server</CodeBlock>
  </TabItem>
</Tabs>
...
For a complete list of configuration options, refer to the [configuration documentation](../configuration/index.md).
