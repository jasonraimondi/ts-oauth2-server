...
export function GithubLogo() {
  return (
    <svg width="100%" height="100%" viewBox="0 0 1024 1024" xmlns="http://www.w3.org/2000/svg" className="fill-current">
  ...
  return (
    ...
    >
      ...
      <div className="flex justify-center gap-8 pt-14">
        <a href="https://github.com/jasonraimondi/ts-oauth2-server"
           className="w-12 text-black hover:text-black"><GithubLogo /></a>
        <a href="https://www.npmjs.com/package/@jmondi/oauth2-server" className="w-12"><NPMLogo /></a>
        <a href="https://jsr.io/@jmondi/oauth2-server" className="w-12"><JSRLogo /></a>
      </div>
